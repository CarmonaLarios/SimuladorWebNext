...
import CardPagamentoPix from '@/components/Cards/CardPagamentoPix';
      ...
      >
        <Grid container >
          ...
          <Grid item xs={12} sx={{mt:3}}>
            <Button variant="contained" sx={{mx:'auto', width:'100%', mb:2}} component={Link} href='/sucesso/pix'>Continuar
            </Button>
